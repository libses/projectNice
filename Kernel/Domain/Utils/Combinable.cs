    ...
    where T : Combinable<T>
{
    ...
    {
        GpuOperations.AddKernel(GetBuffer().IntExtent, GetBuffer().View, other.GetBuffer().View);
        return (this as T)!;
    }
    ...
    public T Multiply<TOther>(Combinable<TOther> other)
        where TOther : Combinable<TOther>
    {
        GpuOperations.MulKernel(GetBuffer().IntExtent, GetBuffer().View, other.GetBuffer().View);
        return (this as T)!;
    }
